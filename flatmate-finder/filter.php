    ...
    <form method="POST" action="filter.php">
        ...
        <?php
            if($_POST['type'] == "Private Hall"){
                echo("<input type='radio' name='type' class='ButtonState' checked id='Private Hall' value='Private Hall'/>");
            } else {
                echo("<input type='radio' name='type' class='ButtonState' id='Private Hall' value='Private Hall'/>");
            }
        ?>
        ...
        <?php
            if($_POST['gender'] == "gAll"){
                echo("<input type='radio' name='gender' class='ButtonState' checked id='gAll' value='gAll'/>");
            } else {
                echo("<input type='radio' name='gender' class='ButtonState' checked id='gAll' value='gAll'/>");
            }  
        ?>
        ...
        <?php
            if($_POST['gender'] == "Male"){
                echo("<input type='radio' name='gender' class='ButtonState' checked id='Male' value='Male'/>");
            } else {
                echo("<input type='radio' name='gender' class='ButtonState' id='Male' value='Male'/>");
            }  
        ?>
        ...
        <?php
            if($_POST['gender'] == "Female"){
                echo("<input type='radio' name='gender' class='ButtonState' checked id='Female' value='Female'/>");
            } else {
                echo("<input type='radio' name='gender' class='ButtonState' id='Female' value='Female'/>");
            }  
        ?>
        <label class="Button" for="Female">Female</label>

        <?php
            if($_POST['gender'] == "No Preference"){
                echo("<input type='radio' name='gender' class='ButtonState' checked id='No Preference' value='No Preference'/>");
            } else {
                echo("<input type='radio' name='gender' class='ButtonState' id='No Preference' value='No Preference'/>");
            }  
        ?>
...
<!-- Proporties here -->
        ...
        <?php    
            ...
            if ($type != "tAll"){
                if($gender != "gAll"){
                    $sql = "SELECT * FROM Post WHERE RoomType='$type' AND Gender='$gender' ORDER BY post_id DESC";
                }else{
                    $sql = "SELECT * FROM Post WHERE RoomType='$type' ORDER BY post_id DESC";
                }
            }else{
                if($gender != "gAll"){
                    $sql = "SELECT * FROM Post WHERE Gender='$gender' ORDER BY post_id DESC";
                }else{
        ...
        <?php        
                ...
                echo("Sorry~~ No such a post. How about Create A Post?");
                echo("</div>");
            }
  ...
  <div class="container text-center">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-5 text-right scrollimation fade-up d1">
        ...
        <p class="whiteText fredokaFont">You can use these services as you see fit. Your data will be kept private per the <a style="color:#B77682" href="../home/Privacy_Policy.pdf" download=>Privacy Policy</a>
